#
#  Be sure to run `pod spec lint jmTools.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/simplismvip/JMTools.git", :tag => "#{spec.version}" }
  ...
  spec.framework  = "UIKit", "Foundation","Photos","AVFoundation" #支持的框架
